...
Data are full of uncertainty. To answer any of your questions, you will need to wrestle with questions around significance and strength of effects:
...
Because the test statistic is created by standarizing the estimated effect using the mean and standard error specified by the null hypothesis, we can use the standard normal distribution for the sampling distribution. 
...
- With a large enough sample, you can find significance in the tiniest effects
...
power_plot / (sign_plot + magnitude_plot)
