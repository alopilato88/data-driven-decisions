...
$$\text{P-Value} =P(\lvert Z \rvert \space | H_0 = True)\times2$$
...
Not for data measured with error, with small effects and small sample sizes---people data

With people data (and similar types), we can expect to make some statistical errors.
...
## Go To Simulation Code

## Impact on Descision

* S1: Type 1 Error - Needlesly spend money
* S2: Type 2 Error - A new analysis with larger sample size could find effect and if rates change then AI ratio changes
* S3: Type-S Error - Potential lawsuit 
* S4: Type-M Error - Overreaction 
...
## Does a Large Sample Solve This? 
